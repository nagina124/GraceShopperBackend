...
productsRouter.post('/', requireAdmin, async (req, res, next) => {
  ...
  try {
    const createdProduct = await createProduct({category, title, description, price, inventory});
...
productsRouter.patch('/:productId', requireAdmin, async (req, res, next) => {
  ...
  try {
    const updatedProduct = await updateProduct({ id: productId, category, title, description, price, inventory });
